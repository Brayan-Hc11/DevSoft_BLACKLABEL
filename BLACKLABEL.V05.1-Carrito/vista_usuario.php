...
<div class="four columns"></div>
    ...
    <div class="two columns u-pull-right">
        <ul>
            <li class="submenu"><i class='fa-solid fa-basket-shopping'></i>
...
<div class='scrol'>
    ...
    <script src="j-carrito.js"></script>
...
class inicioProd{
    ...
    <section class='container top-products' id='lista-productos'>
...
<!-------------------------------------------------------------------------------------------------------------------------->
            <div class='card-product'>
                ...
                <a href='PROD/Prod_laptop1.php'><img src='IMG_PROD/img_laptop1.png' class='imagen producto'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->    
            <div class='card-product'>
                <div class='container-img'>
                <a href='PROD/Prod_Monitores2.php'><img src='IMG_PROD/img_Pantalla2.png' class='imagen producto'/></a> 
                ...
                <span class='add-cart agregar-carrito' data-id='42'>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Smartphone1.PHP'><img src='IMG_PROD/img_Smarftphone1.png' class='imagen producto' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Laptop2.php'><img src='IMG_PROD/img_laptop2.png' class='imagen producto' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Laptop5.php'><img src='IMG_PROD/img_Laptop5.png' class='imagen producto' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
            <div class='card-product'>
                <div class='container-img'>
                <a href='PROD/Prod_Laptop6.php'><img src='IMG_PROD/img_laptop6.png' class='imagen producto'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->    
            <div class='card-product'>
                <div class='container-img'>
                <a href='PROD/Prod_Monitores1'><img src='IMG_PROD/img_Pantalla1.png' class='imagen producto' /></a> 
                ...
                <span class='add-cart agregar-carrito'  data-id='41'>
                <i class='fa-solid fa-basket-shopping'></i>
            </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Smartphone6.php'><img src='IMG_PROD/img_Smarftphone6.png' class='imagen producto'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Auriculares2.php'><img src='IMG_PROD/img_Auricular2.png' class='imagen producto' /></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='34'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
                <p class='price'>
                $ 579.900<span></span></p>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Tableta7.php'><img src='IMG_PROD/img_Tableta7.png' class='imagen producto' /></a> 
...
<section class='galleryg'>
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Ordenadores1.php'><img src='IMG_PROD/img_Ordenador1.png'class='imagen producto' /></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='25'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Ordenadores2.php'><img src='IMG_PROD/img_Ordenador2.png' class='imagen producto'/></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='26'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Auriculares5.php'><img src='IMG_PROD/img_Auricular5.png' class='imagen producto'/></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='37'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Laptop8.php'><img src='IMG_PROD/img_Laptop8.png' class='imagen producto'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Smartphone8.php'><img src='IMG_PROD/img_Smarftphone8.png' class='imagen producto'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
            <div class='card-product'>
                <div class='container-img'>
                <a href='PROD/Prod_Ordenadores7.php'><img src='IMG_PROD/img_Ordenador7.png' class='imagen producto'/></a> 
                ...
                <span class='add-cart agregar-carrito' data-id='31'>
                <i class='fa-solid fa-basket-shopping'></i>
            </span>
                        <p class='price'>
...
<!-------------------------------------------------------------------------------------------------------------------------->    
            <div class='card-product'>
                <div class='container-img'>
                <a href='PROD/Prod_Smartphone4.php'><img src='IMG_PROD/img_Smarftphone4.png' class='imagen producto'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Auriculares6.php'><img src='IMG_PROD/img_Auricular6.png' class='imagen producto'/></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='38'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Monitores8.php'><img src='IMG_PROD/img_Pantalla8.png' class='imagen producto'/></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='48'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='PROD/Prod_Auriculares7.php'><img src='IMG_PROD/img_Auricular7.png' class='imagen producto' class='imagen producto'/></a> 
        ...
        <span class='add-cart agregar-carrito' data-id='39'>
        <i class='fa-solid fa-basket-shopping'></i>
    </span>
