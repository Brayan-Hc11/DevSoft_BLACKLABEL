...
<main class="main-container">
  <header class="header">
    ...
    <div class="header__navigation">
      <img class="header__menu" src="icon-menu.svg" alt="Menú">
      <a href="../../blackLabel.html" class="header__menu--logo">BlackLabel</a>
      <!--Declaramos un navbar-->
      <nav class="navbar">
        <ul class="navbar__items">
          <li><a href="#" class="navbar__link">Hogar </a></li>
      ...
      <div class="modal-navbar__background">
        <nav class="modal-navbar">
          ...
          <ul class="modal-navbar__items">
            <li><a href="#l" class="modal-navbar__link">Hogar</a></li>
            <li><a href="#" class="modal-navbar__link">Productos</a></li>
      ...
      <div class="header__cart-avatar">
        ...
        <img class="header__avatar" src="icono-avatar.png" alt="Icono del avatar del usuario"/>
...
<section class="content">
  ...
  <!--Imagnes de miniaturas del producto-->
    <div class="gallery__thumnails">
      ...
      <img id="2" class="gallery__thumnail" src="image-product-2-thumbnail.jpg" alt="Miniatura">
      <img id="3" class="gallery__thumnail" src="image-product-3-thumbnail.jpg" alt="Miniatura">
      <img id="4" class="gallery__thumnail" src="image-product-4-thumbnail.jpg" alt="Miniatura">
    </div>
  </article>
...
<div class="cart-modal">
  ...
  <div class="cart-modal__chekout-container">
    ...
    <div class="cart-modal__details-container">
      <img class="cart-modal__image" src="image-product-1-thumbnail.jpg" alt="producto">
    ...
    <article class="gallery">
      ...
      <!--Imagnes de miniaturas del producto-->
        <div class="modal-gallery__thumnails">
          <img id="m1" class="modal-gallery__thumnail" src="image-product-1-thumbnail.jpg" alt="Miniatura">
          <img id="m2" class="modal-gallery__thumnail" src="image-product-2-thumbnail.jpg" alt="Miniatura">
          <img id="m3" class="modal-gallery__thumnail" src="image-product-3-thumbnail.jpg" alt="Miniatura">
          <img id="m4" class="modal-gallery__thumnail" src="image-product-4-thumbnail.jpg" alt="Miniatura">
        </div>
      </article>
  </div>
<!--fin gallery modal-->
  ...
  <script src="j-productos.js"></script>
</body>
</html>