...
<section class='informacion'>
    <div class='informacion__content container'>
        ...
        <h1 class='informacion__titulo--primario'>¿Cómo Funciona BlackLabel?</h1>
            ...
            <img src='IMG/img-numero-1-min.png'width='50' height='50' alt='icono del número uno'>
            ...
            <div class='informacion__blog--descripccion'>
           <img src='IMG/img-numero-2-min.png'width='43' height='43' alt='icono del número dos'>
            ...
            <div class='informacion__blog--descripccion'>
            <img src='IMG/img-numero-3-min.png'width='43' height='43' alt='icono del número tres'>
...
<section class='informacion'>
    ...
    <div class='informacion__blog--content'>
        ...
        <div class='informacion__blog--descripccion'>
        <img src='IMG/img-diseño-sencillo-min.png'width='60' height='60' alt='beneficio uno'>
        ...
        <div class='informacion__blog--descripccion'>
        <img src='IMG/img-intuitivo-min.png'width='60' height='60' alt='beneficio dos'>
        ...
        <div class='informacion__blog--descripccion'>
        <img src='IMG/img-facil-manejo-min.png'width='60' height='60' alt='beneficio tres'>
