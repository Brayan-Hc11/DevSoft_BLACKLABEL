	...
	<header>
		...
		<main>
			<div class="container-img">
				<img src="productos/img_Smarftphone8.png"alt="imagen-producto"/>
			</div>
			
            <div class="container-info-product">
				<div class="container-price">
					<span>$ 1.789.000 </span><span></span>
					<i class="fa-solid fa-angle-right"></i>
				</div>

				<div class="container-details-product">
					<div class="form-group">
                        iPhone 7 32 GB plata
					</div>
...
<ul>
    ...
    <li>Pantalla IPS de 4.7".</li>

    <li>Cámara trasera de 12Mpx.</li>

    <li>Cámaras delanteras de 7 MP.</li>

    <li>Procesador Apple A10 Fusion Quad-Core de 2.34GHz con 2GB de RAM.</li>

    <li>Batería de 1960mAh.</li>
...
¡Desenchúfate! Con la súper batería de 5000 mAh tendrás energía por mucho más tiempo para jugar, ver series o trabajar sin necesidad de realizar recargas.
				...
				<div class="container-reviews">
					<div class="title-reviews">
						<h4>Características de Xiaomi Redmi Note 10</h4>
						<i class="fa-solid fa-chevron-down"></i>
					</div>
...
<li>
Tamaño de la pantalla: 6.43 "
(160.46 mm x 74.5 mm x 8.29 mm)
</li>
		...
		<section class="container-related-products">
			...
			<div class="card-list-products">
                ...
                <div class="card">
                    ...
                    <div class="card-img">
						<img src="productos/img_Smarftphone6.png"alt="producto-2"/>
					</div>
                ...
                <div class="card">
					<div class="card-img">
						<img src="productos/img_Smarftphone7.png"alt="producto-3"/>
					</div>
