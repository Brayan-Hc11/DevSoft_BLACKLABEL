    ...
    class inicioProd {
        public function vistaProd() {
            ...
            <main class='productos__medio'>
                ...
                <div id='lista-productos' class='container top-products'>
                        ...
                        <!-------------------------------------------------------------------------------------------------------------------------->
                            <div class='card-product'>
                                ...
                                <div class='content-card-product'>
                                    ...
                                    <span class='add-cart agregar-carrito'  data-id='7'>
                                        <i class='fa-solid fa-basket-shopping'></i>
                                    </span>
                        ...
                        <!-------------------------------------------------------------------------------------------------------------------------->
                            <div class='card-product'>
                                ...
                                <div class='content-card-product'>
                                    ...
                                    <p class='price'>$ 579.900<span></span></p>
                                </div>
                            </div>
                        ...
                        <!-------------------------------------------------------------------------------------------------------------------------->
                            <div class='card-product'>
                                ...
                                <div class='content-card-product'>
                                    ...
                                    <p class='price'>$ 1.450.000<span></span></p>
                                </div>
                            </div>
                        ...
                        <!-------------------------------------------------------------------------------------------------------------------------->
                            <div class='card-product'>
                                ...
                                <div class='content-card-product'>
                                    ...
                                    <h3><a href='PROD/Prod_Auriculares6.php'>Audífonos in-ear gamer</a></h3>
                        ...
                        <!-------------------------------------------------------------------------------------------------------------------------->
                            <div class='card-product'>
                                ...
                                <div class='content-card-product'>
                                    ...
                                    <h3><a href='PROD/Prod_Auriculares7.php'>Audífonos in-ear gamer inalámbricos</a></h3>
