	...
	<header>
		...
		<main>
			<div class="container-img">
				<img src="../IMG_PROD/img_Smarftphone7.png"alt="imagen-producto"/>
			</div>
			
            <div class="container-info-product">
				<div class="container-price">
					<span>$ 801.900</span><span></span>
					<i class="fa-solid fa-angle-right"></i>
				</div>

				<div class="container-details-product">
					<div class="form-group">
                        Xiaomi Redmi Note 10 Dual SIM 128 GB blanco gijarro 4 GB RAM
					</div>
				...
				<div class="container-add-cart">
					...
					<button class="btn-add-to-cart" data-id='7'>
...
<ul>
    <li>
    Disispositivo desbloqueado para que elijas la compañía telefónica que prefieras.
    </li>
    ...
    <li>
    Procesador Snapdragon 678 Octa-Core de 2.2GHz con 4GB de RAM.
    </li>
		...
		<section class="container-related-products">
			...
			<div class="card-list-products">
                ...
                <div class="card">
                    ...
                    <div class="card-img">
						<img src="../IMG_PROD/img_Smarftphone6.png"alt="producto-2"/>
					</div>
