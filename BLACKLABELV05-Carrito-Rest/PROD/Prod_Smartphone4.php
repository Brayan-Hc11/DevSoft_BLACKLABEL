	...
	<header>
		...
		<main>
			<div class="container-img">
				<img src="../IMG_PROD/img_Smarftphone4.png"alt="imagen-producto"/>
			</div>
			
            <div class="container-info-product">
				<div class="container-price">
					<span>$ 315.499 </span><span class='Descuento'>5% OFF</span>
					<i class="fa-solid fa-angle-right"></i>
				</div>

				<div class="container-details-product">
					<div class="form-group">
                        Smartphone Tecno Pop 7 2023 64+4gb 5000 Mah 2sim 4g Dual Cam
					</div>
				...
				<div class="container-add-cart">
					...
					<button class="btn-add-to-cart" data-id='4'>
...
Con su memoria interna de 64 GB siempre tendrás espacio para almacenar archivos y documentos importantes. Además, podrás guardar películas, series y videos para reproducirlos cuando quieras sin conexión.
				...
				<div class="container-reviews">
					<div class="title-reviews">
						<h4>Características de Tecno Pop 7 2023 64Gb</h4>
						<i class="fa-solid fa-chevron-down"></i>
					</div>
