    ...
    <div class='informacion__content container'>
        ...
        <h1 class='informacion__titulo--primario'>¿Cómo Funciona BlackLabel?</h1>
            ...
            <div class='informacion__blog--descripccion'>
                <img src='img_numero-1.png'width='43' height='43' alt='icono del número uno'>
            ...
            <div class='informacion__blog--descripccion'>
                <img src='img_numero-2.png'width='43' height='43' alt='icono del número dos'>
            ...
            <div class='informacion__blog--descripccion'>
                <img src='img_numero-3.png'width='43' height='43' alt='icono del número tres'>
...
<section class='informacion'>
    ...
    <div class='informacion__blog--content'>
        ...
        <div class='informacion__blog--descripccion'>
            <img src='img_pulgar-arriba.png'width='43' height='43' alt='beneficio uno'>
        ...
        <div class='informacion__blog--descripccion'>
            <img src='img_grafico-barras.png'width='43' height='43' alt='beneficio dos'>
        ...
        <div class='informacion__blog--descripccion'>
            <img src='img_verificacion.png'width='43' height='43' alt='beneficio tres'>
...
$final = new iniInformacion();
    $final -> vistaInformation();
?>