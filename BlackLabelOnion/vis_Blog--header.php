    ...
    <header class='Blog__Header--Blog'>
        ...
        <div class='Blog__Menu contenedor'>
            ...
            <label for='Blog__Menu--menu'>
                <img src='img_grafico-barras.png' alt='imagen' class='Blog__Menu--icono'>
            </label>
            ...
            <nav class='Blog__Menu--Navbar'
                <ul>
                    ...
                    <li><a href='vis_productos.php'>Productos</a></li>
        ...
        <div class='Header__Content contenedor'>
            <div class='Header__Content--Text'>
                ...
                <a href='#' class='Header__Content--Enlace-1'>Información </a>
            </div>
        </div>
    </header>
    </body>
