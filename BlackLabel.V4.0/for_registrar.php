...
<div class='container__formulario--login'>
    <div class='form-boxregister'>
        <div class='button-box'>
            ...
            <form id='Registrar' class='input-group' method='post' action='neg_registrar.php'>
                <input type='text' class='input-field' placeholder='Nombres'  required name='nombre_usuario'>
                <input type='text' class='input-field' placeholder='Apellidos' required  name='apellido_usuario'>
                <input type='number' class='input-field' placeholder='Documento' required  name='documento'>
                <input type='email' class='input-field' placeholder='Correo electronico' required  name='correo'>
                <input type='password' class='input-field' placeholder='Contraseña' required  name='contraseña'>
                <input type='checkbox' required class='check-box'><span class='contraseña'>Acepta terminos  y condiciones.</span>
