    ...
    <section class='container top__categories'>
        ...
        <div class='container-categories'>
            ...
            <div class='card-category category-element1'>
                <p>Elemento 1</p>
               <span class='blanco'><a href='Cpa_mid-Categorias_html.php'>ver más</a></span>
            </div>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Smartphone1.php'><img src='productos/img_Smarftphone1.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Laptop2.php'><img src='productos/img_laptop2.png' /></a> 
        ...
        <h3><a href='Prod_Laptop2.php'>Portátil Lenovo IdeaPad </a></h3>
            <span class='add-cart'>
                <i class='fa-solid fa-basket-shopping'></i>
            </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Laptop5.php'><img src='./productos/img_Laptop5.png' /></a> 
        ...
        <h3><a href='Prod_Laptop5.php'>Portátil gamer Asus TUF Gaming</a></h3>
            <span class='add-cart'>
                <i class='fa-solid fa-basket-shopping'></i>
            </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
            <div class='card-product'>
                <div class='container-img'>
                <a href='Prod_Laptop6.php'><img src='./productos/img_laptop6.png'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->    
            <div class='card-product'>
                <div class='container-img'>
                <a href='Prod_Monitores1.php'><img src='./productos/img_Pantalla1.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Smartphone6.php'><img src='./productos/img_Smarftphone6.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Auriculares2.php'><img src='./productos/img_Auricular2.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Tableta7.php'><img src='./productos/img_Tableta7.png' /></a> 
...
<section class='galleryg'>
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Ordenadores1.php'><img src='./productos/img_Ordenador1.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Ordenadores2.php'><img src='./productos/img_Ordenador2.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Auriculares5.php'><img src='./productos/img_Auricular5.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Laptop8.php'><img src='./productos/img_Laptop8.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Smarftphone8.php'><img src='./productos/img_Smarftphone8.png' /></a> 
        ...
        <h3><a href='Prod_Smarftphone8.php'>iPhone 7 32 GB plata</a></h3>
            <span class='add-cart'>
                <i class='fa-solid fa-basket-shopping'></i>
            </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
            <div class='card-product'>
                <div class='container-img'>
                <a href='Prod_Ordenadores7.php'><img src='./productos/img_Ordenador7.png'/></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->    
            <div class='card-product'>
                <div class='container-img'>
                <a href='Prod_Smarftphone4.php'><img src='./productos/img_Smarftphone4.png' /></a> 
                ...
                <h3><a href='Prod_Smarftphone4.php'>Smartphone Tecno Pop</a></h3>
                    <span class='add-cart'>
                        <i class='fa-solid fa-basket-shopping'></i>
                    </span>
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Auriculares6.php'><img src='./productos/img_Auricular6.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Monitores8.php'><img src='./productos/img_Pantalla8.png' /></a> 
...
<!-------------------------------------------------------------------------------------------------------------------------->
    <div class='card-product'>
        <div class='container-img'>
        <a href='Prod_Auricular7.php'><img src='./productos/img_Auricular7.png' /></a> 
