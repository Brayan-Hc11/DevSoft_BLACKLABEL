    ...
    <body>
		...
		<main>
			<div class="container-img">
				<img src="productos/img_Smarftphone2.png"alt="imagen-producto"/>
			</div>
			
            <div class="container-info-product">
				<div class="container-price">
					<span>$ 1.769.900</span><span class="Descuento">16% OFF</span>
					<i class="fa-solid fa-angle-right"></i>
				</div>

				<div class="container-details-product">
					<div class="form-group">
                    Xiaomi 12 Dual SIM 256 GB azul 8 GB RAM
					</div>
...
<ul>
    ...
    <li>Pantalla AMOLED de 6.28".</li>
    <li>Tiene 3 cámaras traseras de 50Mpx/13Mpx/5Mpx.</li>
    <li>Cámara delantera de 32Mpx.</li>
    <li>Procesador Snapdragon 8 Gen 1 Octa-Core de 3GHz con 8GB de RAM.</li>
    <li>Batería de 4500mAh con carga inalámbrica.</li>
...
Mira tus series y películas favoritas con la mejor definición a través de su pantalla AMOLED de 6.28". Disfruta de colores brillantes y detalles precisos en todos tus contenidos.
</p><br>
...
¡Desenchúfate! Con la súper batería de 4500 mAh tendrás energía por mucho más tiempo para jugar, ver series o trabajar sin necesidad de realizar recargas.
</p><br>
				...
				<div class="container-reviews">
					<div class="title-reviews">
						<h4>Características de Xiaomi 12</h4>
						<i class="fa-solid fa-chevron-down"></i>
					</div>
...
<li>Tamaño de la pantalla: 6.28 "
(152.7 mm x 69.9 mm x 8.16 mm)</li>
